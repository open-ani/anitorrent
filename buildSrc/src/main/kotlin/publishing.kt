...
fun MavenPublishBaseExtension.configurePom(project: Project) {
    pom {
        ...
        url.set("https://github.com/open-ani/anitorrent")

        licenses {
            license {
                name.set("GNU General Public License, Version 3")
                url.set("https://github.com/open-ani/anitorrent/blob/main/LICENSE")
        ...
        scm {
            connection.set("scm:git:https://github.com/open-ani/anitorrent.git")
            developerConnection.set("scm:git:git@github.com:open-ani/anitorrent.git")
            url.set("https://github.com/open-ani/anitorrent")
        }
    }
}
